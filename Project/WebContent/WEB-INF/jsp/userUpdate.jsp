...
<br><p class="example6"><b>ユーザ名</b> <input type="text" name="name" value="${user.name}" class="example7"></p>

<br><p class="example7"><b>生年月日</b> <input type="date" name="birth_date" value="${user.birth_date}" class="example7"></p>

<div align="center">
<br><p><input type="submit" value="更新" class="example1"></p>
</div>
</form>
